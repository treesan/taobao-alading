...
{
    public partial class InitShop : DevExpress.XtraEditors.XtraForm
    {
        /// <summary>
        /// 子线程列表
        /// </summary>
        ...
        private void InitShop_Load(object sender, EventArgs e)
        {
            List<ShopEntity> shopEntityList = null;
            if (SystemHelper.ShopList != null)
            {
        ...
        void worker_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            ...
            {
                BeginInvoke(new Action(() => { listBoxCtrl.Items.Insert(0, state.Message); }));
            }
            else
            {
                BeginInvoke(new Action(() =>
                {
                    ...
                    listBoxCtrl.Items.Insert(0, string.Format("子线程{0},第{1}个宝贝下载成功，编号为：{2}。", state.ItemTaskIndex, state.Index, state.Iid));
                }));
            }
        }
    ...
    {
        public List<Taobao.Entity.Item> ItemList
        {
            get;
            set;
        }
    ...
    /// 列表中的Shop
    /// </summary>
    public class ShopEntity : Alading.Entity.Shop
    {
        /// <summary>
        /// 是否选中
        /// </summary>
    ...
    /// 商品下载对象
    /// </summary>
    public class ItemEntity : Alading.Entity.Item
    {
        /// <summary>
        /// 是否选中
        /// </summary>
